...
void display(void)
{
	...
	//earth
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(tierra), glm::vec3(0, 1, 0.5));
	...
	//jupiter
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(jupiter), glm::vec3(0, -1, 0.5));
	model = glm::translate(model, glm::vec3(6.0, 0, 0));
