...
void myData()
{
	...
	float vertices[] = 
	{
		//para A
		// positions         //color
		-0.7f,  -0.6f, 0.0f, 0.75f,0.3f,0.0f, // V0
		-0.5f, -0.6f, 0.0f,  0.75f,0.3f,0.0f,// V1
		-0.5f, -0.2f, 0.0f,  0.75f,0.3f,0.0f,// V2
		-0.7f, 0.6f, 0.0f,	 0.75f,0.3f,0.0f,// V7

		-0.3f,  -0.2f, 0.0f, 0.75f,0.3f,0.0f,  // V3
		-0.3f,  -0.6f, 0.0f, 0.75f,0.3f,0.0f, // V4
		-0.1f,  -0.6f, 0.0f, 0.75f,0.3f,0.0f, // V5
		-0.1f, 0.6f, 0.0f,   0.75f,0.3f,0.0f,// V6

		-0.5f, 0.0f, 0.0f,  0.75f,0.3f,0.0f,// V8
		-0.3f, 0.0f, 0.0f,  0.75f,0.3f,0.0f,// V9
		-0.3f, 0.3f, 0.0f,  0.75f,0.3f,0.0f,// V10
		-0.5f, 0.3f, 0.0f,  0.75f,0.3f,0.0f,// V11
		...
		//Para O
		0.1f, -0.6f, 0.0f, 0.0f,0.2f,0.5f, // V0
		0.7f, -0.6f, 0.0f,  0.0f,0.2f,0.5f,// V1
		0.5f, -0.3f, 0.0f,  0.0f,0.2f,0.5f,// V2
		0.3f, -0.3f, 0.0f,  0.0f,0.2f,0.5f,  // V3
		0.3f,  0.3f, 0.0f,  0.0f,0.2f,0.5f, // V4
		0.1f,  0.6f, 0.0f,  0.0f,0.2f,0.5f,// V5

		0.7f,  0.6f, 0.0f,  0.0f,0.2f,0.5f,// V6
		0.7f, -0.6f, 0.0f,  0.0f,0.2f,0.5f,// V1
		0.5f, -0.3f, 0.0f,  0.0f,0.2f,0.5f,// V2
		0.5f,  0.3f, 0.0f,  0.0f,0.2f,0.5f,// V7
		0.3f,  0.3f, 0.0f,  0.0f,0.2f,0.5f,// V4
		0.1f,  0.6f, 0.0f,  0.0f,0.2f,0.5f,// V5

		//0.6f, 0.4f, 0.0f,  1.0f,0.0f,0.0f,// bottom left
	};

	unsigned int indices[] =
	{
		//0, 1, 2, 3, 4, 5, 6, 7 //orden para dibujar los vertices[] anteriores
		//3, 2, 4, 7
		//3, 2, 8, 11, 10, 7
		3, 2, 8, 11, 10, 7
	};
...
void setupShaders() //orden para ejecutar los shaders
{
	...
	//ya con el Programa, el Shader no es necesario-- borra los shaders
...
void display(void)//para dibujar los shaders
{
	...
	glPointSize(5.0);
	glDrawElements(GL_POLYGON, 6, GL_UNSIGNED_INT, 0); //(especifica_que_dibujara_punto,cantidad,orden_anteriormente_hecho,siempre debe ser cero)
	//glDrawArrays(GL_POLYGON, 0, 4);
	//glDrawArrays(GL_POLYGON, 3, 1);
	glDrawArrays(GL_POLYGON, 0, 4);
	...
	glDrawArrays(GL_POLYGON, 26, 6);
	//glDrawArrays(GL_POLYGON, 4, 4);
	//glDrawArrays(GL_POLYGON, 0, 6);
	//GL_LINES SOLO RECIBE PARES DE VERTICES DE LO CONTRARIO NO LO "TERMINA DE DIBUJAR"
...
// ---------------------------------------------------------------------------------------------------------
void my_input(GLFWwindow *window) //ESOT HACE LO DElos frames por segundo, se dibuja constantemente la figura en pantalla
{
