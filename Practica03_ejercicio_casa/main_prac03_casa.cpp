...
void display(void)
{
	...
	projectionShader.setVec3("color", color);
	...
	//------------------Contorno del escudo-----------------------
	projectionShader.setVec3("color", glm::vec3(0.3f, 0.0f, 0.0f));
	glDrawArrays(GL_QUADS, 0, 24); //A lonely cube :(

	model = glm::translate(model, glm::vec3(1.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //tercer cubo
	...
	//parte blanca
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setVec3("color", glm::vec3(0.8f, 0.8f, 0.8f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //otro cubo :v
	...
	//color rojo
	model = glm::translate(model, glm::vec3(2.0f, -13.0f, 0.0f));
	projectionShader.setVec3("color", glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	...
	projectionShader.setVec3("color", glm::vec3(1.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
